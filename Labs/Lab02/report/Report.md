...
$$
r = \frac{11.7}{4.7} e^{\frac{1}{\sqrt{12.69}} \theta} \text{ -- для случая (1)}
$$
...
```julia
solution1(theta) = (11.7/4.7)*exp(1/sqrt(11.44)*theta)

solution2(theta) = (11.7/2.7)*exp(5*pi*sqrt(299)/299)*exp(1/sqrt(11.44)*theta) 
