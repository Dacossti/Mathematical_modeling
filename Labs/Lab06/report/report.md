...
![Динамика изменения числа людей 1 (Julia)](image/image1.png "Динамика изменения числа людей 1"){ #fig:001 width=70% height=70% }
2. если  $I(0) > I^{\ast} $

![Динамика изменения числа людей 2 (Julia)](image/image2.png "Динамика изменения числа людей 2"){ #fig:002 width=70% height=70% }
