...
$\frac{dM}{dt} = - \frac{M δ}{\tau} + NQp - \kappa$
...
Система уравнений динамики оборотных средств можно записать в виде:
...
$a_1 = \frac{P_{cr}}{t_1^2 \tilde{p}_1^2 Nq$
$a_2 = \frac{P_{cr}}{t_2^2 \tilde{p}_2^2 Nq$
$b = \frac{P_{cr}}{t_1^2 t_2^2 \tilde{p}_1^2 \tilde{p}_2^2 Nq$
$c_1 = \frac{P_{cr} - \tilde{p_1}}{t_1 \tilde{p}_1$
$c_2 = \frac{P_{cr} - \tilde{p_2}}{t_2 \tilde{p}_2$

Поскольку постоянные издержки 4(\kappa_1, \kappa_2)$ пренебрежимо малы и $t = c_1 \theta$, задача сводится к решению данной системы уравнений

$$
\begin{cases}
	\frac{dM_1}{d\theta} = M_1 - \frac{b}{c_1} M_1 M_2 - \frac{a_1}{c1} M_1^2\\
...
![График изменения оборотных средств №1 (Julia)](image/image1.jpg){ #fig:001 width=70% }
...
![График изменения оборотных средств №2 (Julia)](image/image2.jpg){ #fig:002 width=70% }
...
plot(sol, label= ["Фирма 1" "Фирма 2"], xlabel = "θ", title="Случай №1")
...
plot(sol, label= ["Фирма 1" "Фирма 2"], xlabel = "θ", title="Случай №2")
savefig("image2.png")
```
